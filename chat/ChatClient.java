...
public class ChatClient extends JFrame implements ActionListener, KeyListener {
   ...
   public ChatClient(int index,ArrayList<ChatInformation> list) {
     ...
     this.list=list;
      ...
      textA.setFont(new Font("휴먼매직체",Font.BOLD, 17));
      ...
      text.setFont(new Font("휴먼매직체",Font.BOLD, 17));
...
/////////////////////////////////////////////////////////////////////////////////////
      try {
         socket = new Socket("192.168.219.104", PORT);
         oos = new ObjectOutputStream(socket.getOutputStream());
         ois = new ObjectInputStream(socket.getInputStream());
         ChatClientThread tc = new ChatClientThread(this);
         tc.start();
   ...
   public void keyPressed(KeyEvent e) {
      // TODO Auto-generated method stub
        if(e.getKeyCode()==KeyEvent.VK_ENTER) {
           try {
              oos.writeObject("최불암#"+text.getText());         
         } catch (Exception e2) {
            // TODO: handle exception
         }        
           text.setText("");       
